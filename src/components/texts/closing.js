...
export default function Closing(props) {
  return (
    <>
      ...
      Keep up with us:<br/>
      <a className="link" href="https://www.instagram.com/anand.chandra/" rel="noopener noreferrer" target="_blank">@anand.chandra</a><br/>
      <a className="link" href="https://www.instagram.com/nathan.siu/" rel="noopener noreferrer" target="_blank">@nathan.siu</a><br/>
      </div><br/>
    </>
  );

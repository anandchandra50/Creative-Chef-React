    ...
    <>
      <div className="text__body">
        ...
        {isMobile ?
          ...
          :
          <>
            Download: <a className="link" href={flavorCheatsheet1} download>Flavor Profiles 1</a><br/>
            Download: <a className="link" href={flavorCheatsheet2} download>Flavor Profiles 2</a><br/>
            Download: <a className="link" href={cookingMethodsCheatsheet} download>Cooking Methods</a>
          </>
        }
      </div>
    </>

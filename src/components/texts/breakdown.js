  ...
  return (
    <>
      <div className="text__body">
        ...
        The cooking methods bring all components together. Like the other elements, cooking methods are intentionally chosen: searing a fish filet develops a crusted exterior, whereas steaming it creates a smooth bite.<br/><br/>
        Presentation is the finishing touch: the layering, garnish, and colors. It’s serving curry over rice, sprinkling parsley and grated cheese over pasta, and drizzling white heavy cream over red tomato soup. Each of these additions improve the visual appeal: <span className="bold">presentation transforms food into art.</span>
      </div>
    </>
  );

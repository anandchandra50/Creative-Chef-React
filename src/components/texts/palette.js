  ...
  return (
    <>
      <div className="text__body">
        ...
        Once you are comfortable with identifying flavor and texture, pay attention to their balance. There is no magic ingredient that does everything. Your perfect steak, an A5 Wagyu, would get boring by itself. An average ribeye with roasted potatoes and creamed spinach, complimented by a glass of wine is much more interesting. Try to identify the different parts of each meal, and how they balance each other.<br/><br/>
        <span className="bold">The goal is to train your palette to identify flavors and textures.</span> The more dishes you taste intentionally, the more experience you will have to recreate the flavor and texture combinations you like.<br/><br/>
      </div>
    </>
  );

  ...
  return (
    <>
      <div className="text__body">
        ...
        Let’s say you’re eating a steak dish. Maybe you taste salt and pepper from the seasoning, game from the steak, and a mushroom flavor from the sauce. <span className="bold">If you list and categorize these flavors, you can expand your cooking toolkit so when you decide to make a steak dish, you know what to aim for.</span><br/><br/>
